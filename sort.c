...
/*   Updated: 2019/06/06 09:21:08 by chford           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		sort_alpha_node(t_f_node *n1, t_info n2)
{
	...
	while ((n1->f_name)[i] == n2.f_name[i] && (n1->f_name)[i] != '\0')
		i++;
	if (ft_isalnum(n1->f_name[i]) == 0 &&
			n1->f_name[i] != '.' && ft_isupper(n2.f_name[i]))
		ret = 1;
	else if (ft_isalnum(n1->f_name[i]) == 0 &&
			n1->f_name[i] != '.' && ft_islower(n2.f_name[i]))
		ret = 0;
	else if (ft_isalnum(n2.f_name[i]) == 0 &&
			n2.f_name[i] != '.' && ft_isupper(n1->f_name[i]))
		ret = 0;
	else if (ft_isalnum(n2.f_name[i]) == 0 &&
			n2.f_name[i] != '.' && ft_islower(n1->f_name[i]))
		ret = 1;
	else
